 ...
 * offline queue). Two triggers can fire together, configure() at stack start
 * and the NetworkMonitor on-available listener; each used to send from its
 * own snapshot of the queue, so a queued message and its RFed SPEC §17.11
 * sent-copy went out twice.
 *
